...
export const AnimeCard = memo(({ name, poster, episodes, className }: AnimeCardProps) => {
  ...
  const isActive = thumbnailHovered || touchActive;
    ...
    <div className={`w-full ${className || ''}`}>
      ...
      <div className="mt-2">
        <div className="flex items-center gap-2 mb-1">
          ...
          <p 
            className={`text-xs truncate flex-1 cursor-pointer transition-colors duration-200 ${
              isActive ? 'text-anime-primary' : 'text-white hover:text-anime-primary'
            }`}
            title={name}
          >
            {name}
        ...
        <div className="flex items-center gap-1.5 text-[10px] text-anime-text-muted overflow-x-auto scrollbar-hide">
          <span className="bg-anime-card-bg px-2 py-1 rounded-lg flex-shrink-0 inline-flex items-center font-bold cursor-pointer hover:text-anime-primary transition-colors">
            TV
          </span>
          <span className="bg-anime-card-bg px-2 py-1 rounded-lg flex-shrink-0 inline-flex items-center font-bold cursor-pointer hover:text-anime-primary transition-colors">
            2025
          ...
          {episodes && (
            <span className="bg-anime-card-bg px-2 py-1 rounded-lg text-anime-text-muted inline-flex items-center gap-1 font-bold flex-shrink-0 cursor-pointer hover:text-anime-primary transition-colors">
